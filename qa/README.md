...
- [v5.0.1](v5.0.1/README.md): patch release bug fixes, plus configuration packages — export and import for themes, branding, the login page, navigation and notification categories.
