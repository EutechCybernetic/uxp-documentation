...
```tsx
function publishMessage(context: IContextProvider, channel: string, message: string): IPublishMessage
```

## Examples

```tsx
publishMessage(props.uxpContext, "visitor-arrival", JSON.stringify({ visitorId: 123 }));
```
